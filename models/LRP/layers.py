"""
Adapted from https://github.com/hila-chefer/Transformer-MM-Explainability/tree/main 
"""
...
__all__ = ['forward_hook', 'Clone', 'Add', 'Cat', 'LeakyReLU', 'ReLU', 'GELU', 'Dropout', 'BatchNorm2d', 'Linear', 'MaxPool2d',
